...
export default function ButtonBasic() {
    ...
    useEffect(() => {
        ...
        if (typeof window !== 'undefined') {
            ...
            console.log('ApplePay/GooglePay Component mounted');
        }

        if (!ready || !googlePayReady) {
            console.log('SDK not ready:', { ready, googlePayReady });
            return;
        }
        ...
        (async () => {
            try {
                ...
                console.log('Client token obtained:', clientToken);
                ...
                console.log('Setting up Google Pay button...');
                // setupGooglePayButton(sdkInstance);
                console.log('Google Pay button setup completed');
