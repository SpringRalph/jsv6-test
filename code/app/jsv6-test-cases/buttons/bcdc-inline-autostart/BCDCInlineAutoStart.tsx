    ...
    useEffect(() => {
        ...
        (async () => {
            try {
                ...
                const createOrderPromise = createOrderOverallPayPal(
                    "/api/paypal/order/create/create-order-bcdc-with-more-info",
                );
    ...
    return (
        <div className="relative w-full">
            <EligibilityOverlay
                ...
                message="Checking BCDC Eligibility…"
            />
            <paypal-basic-card-container id="paypal-basic-card-container" className="w-full min-h-[60px] flex flex-col" hidden>
