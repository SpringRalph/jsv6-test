...
import IdealPayments from "./IdealPayments";
                ...
                <div className="relative">
                    ...
                    <div className="bg-gradient-to-br from-blue-50 to-purple-50 dark:from-blue-950/30 dark:to-purple-950/30 p-6 rounded-2xl border-2 border-blue-200 dark:border-blue-800">
                        <h1 className="text-3xl font-bold mb-2 flex items-center gap-3">
                            <Landmark className="size-8 text-blue-500" />
                            IdealPayments
                        </h1>
                        <p className="text-muted-foreground flex items-center gap-2">
                            <span className="text-lg">📝</span>
                            IdealPayments One-Time Payment Integration
                        </p>
                    </div>
                </div>
                ...
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
                    ...
                    <div>
                        <PaymentPlaceholder
                            ...
                            children={<IdealPayments />}
                            placeHolder=""
                            paymentAreaIcon={
                                <Image
                                    src="/payment-area-icon/APM/ideal.svg"
                                    alt="iDeal"
                                    width={100}
                                    height={100}
                                />
