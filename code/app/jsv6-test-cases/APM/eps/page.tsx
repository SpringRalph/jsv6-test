...
import EPSPayments from "./epsPayments";
            ...
            <div className="space-y-6">
                <div className="relative">
                    ...
                    <div className="bg-gradient-to-br from-blue-50 to-purple-50 dark:from-blue-950/30 dark:to-purple-950/30 p-6 rounded-2xl border-2 border-blue-200 dark:border-blue-800">
                        <h1 className="text-3xl font-bold mb-2 flex items-center gap-3">
                            <Banknote className="size-8 text-blue-500" />
                            EPS Payments
                        </h1>
                        <p className="text-muted-foreground flex items-center gap-2">
                            <span className="text-lg">📝</span>
                            EPS Payments One-Time Payment Integration
                        </p>
                    </div>
                </div>
                ...
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
                    ...
                    <div>
                        <PaymentPlaceholder
                            scenario="Austria"
                            children={<EPSPayments />}
                            placeHolder=""
                            paymentAreaIcon={
                                <Image
                                    src="/payment-area-icon/APM/eps.svg"
                                    alt="EPS"
                                    width={100}
                                    height={100}
                                />
