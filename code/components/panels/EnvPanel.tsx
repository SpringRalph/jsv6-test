...
const SHOPPAAS_SANDBOX_CLIENT_ID = "ATIwW9NdRH9Nqde8MCftI_0QbOL9APdYok0a7ircWl2-3fBHv-CoMYsfIDpcUDisqTHmHT7d0Dz9DV7V";
const SHOPPAAS_SANDBOX_SECRET_KEY = "EC-Qcp-6LdYoEw9g02iTkVTRHa49c_HLP19P2hxbSHATN3cov2_G-wmFzp5-Cx2gK3phIzrKhOhbLhPJ"
...
const SANDBOX_CLIENT_ID_OPTIONS: CredentialOption[] = [
    ...
    {
        label: "Shoppaas",
        value: SHOPPAAS_SANDBOX_CLIENT_ID,
    },
];
...
const SANDBOX_SECRET_OPTIONS: CredentialOption[] = [
    ...
    {
        label: "Shoppaas",
        value: SHOPPAAS_SANDBOX_SECRET_KEY,
    },
];
...
export function EnvPanel() {
    ...
    const handleReset = () => {
        ...
        setLocalLiveClientId(
            "AZXvmryZOBQvyeBosxJoMsNbNCYVNGWx5KyArJPYz2O2sEGAOla9s6cI40RVFXHg9oEInNzyQIKzI6tW",
        );
        setLocalLiveSecret(
            "EAx19qrwczQSJeSzQ5FjlzAUAjgd7LJcneDH9k93ZocGWaF4k_oYcX1k8-AvSrJkMvdlncdIUYZSxtf0",
        );
        unloadPayPalWebSdk();
        bumpSdkReloadToken();
    };
