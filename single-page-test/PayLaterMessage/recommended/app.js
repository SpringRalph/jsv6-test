...
async function getBrowserSafeClientToken() {
  // const response = await fetch("http://localhost:8080/paypal-api/auth/browser-safe-client-token", {
  const response = await fetch("https://paypal-backend-api-vercel.vercel.app/api/auth/sandbox-browser-safe-client-token", {
    method: "GET",
    headers: {
